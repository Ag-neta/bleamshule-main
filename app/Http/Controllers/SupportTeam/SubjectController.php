...
use App\Http\Controllers\SupportTeam\sections;

class SubjectController extends Controller
{
    protected $my_class, $user, $sections, $class_id;

    public function __construct(MyClassRepo $my_class, UserRepo $user, SectionsRepo $sections)
    {
    ...
    public function index()
    {
        ...
        $d['sections'] = $this->sections->getAllSections();
